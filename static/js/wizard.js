    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        function renderEditor() {
            ...
            detailEl.innerHTML =
                ...
                '<textarea class="q-def" rows="1" placeholder="Add a definition — what should PreCheck look for on this dimension?"></textarea>';
        ...
        function getActiveSequence() {
            let base;
            if (FLOW === "quality") {
                // Single-document flow: no RR tiles, no multi-study. Quick start asks
                // the field question (step 9) to pick the default criteria set.
                base = defaultModeActive ? [1, 9, 7, 8] : [1, 2, 3, 4, 5, 7, 8];
            } else {
