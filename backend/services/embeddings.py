...
def build_corpus_from_segments(
    ...
    *,
    ...
    ``embed=False`` skips the embedding API entirely and returns a chunk-only
    corpus (empty embeddings matrix) — usable for full-document prompting where
    similarity retrieval is never called."""
